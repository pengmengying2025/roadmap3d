...
Regenerate a render: `node src/cli.mjs render examples/<name>/layergraph.json -o examples/<name>/render`. The `video.mp4` it writes is git-ignored; the published MP4s are on [Release v1.0.0](https://github.com/pengmengying2025/layergraph/releases/tag/v1.0.0).
